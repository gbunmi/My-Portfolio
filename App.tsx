...
const App: React.FC = () => {
  ...
  return (
    ...
    <div className={`flex flex-col bg-[#F8F5F0] text-[#041727] font-mono selection:bg-yellow-200 ${isHome ? 'min-h-screen min-h-[100dvh] relative lg:fixed lg:inset-0 lg:h-full' : 'fixed inset-0 w-full h-full'} ${isLoading ? 'opacity-0' : 'opacity-100'} transition-opacity duration-700 ease-out`}>
      {/* Header */}
