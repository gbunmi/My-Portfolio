...
const FooterLink: React.FC<FooterLinkProps> = ({ label, href, className = '' }) => (
  <a 
    ...
    className={`flex items-center justify-center h-14 hover:bg-[#ecece8] transition-colors text-xs md:text-sm font-bold bg-[#f4f4f0] md:bg-transparent md:border-b-0 tracking-[-0.04em] ${className}`}
  >
    {label}
  </a>
);
...
const Footer: React.FC = () => {
  return (
    <footer className="shrink-0 grid grid-cols-2 md:grid-cols-[240px_repeat(5,1fr)_240px] gap-[1px] md:gap-0 md:divide-x md:divide-gray-300 border-t border-gray-300 bg-gray-300 md:bg-[#f4f4f0]">
